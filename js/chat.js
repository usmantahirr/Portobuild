...
function chatWith(chatuser,user) {
...
function chatHeartbeat(){
	...
	jQuery.ajax({
	  url: "http://localhost/portobuild/php/chat/chat.php?action=chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post("http://localhost/portobuild/php/chat/chat.php?action=closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			jQuery.post("http://localhost/portobuild/php/chat/chat.php?action=sendchat", {to: chatboxtitle, message: message} , function(data){
...
function startChatSession(){  
	jQuery.ajax({
	  url: "http://localhost/portobuild/php/chat/chat.php?action=startchatsession",
	  cache: false,
	  dataType: "json",
