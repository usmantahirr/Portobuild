            ...
            <div class="themeContainer">
                ...
                <div class="flip-container theme" ontouchstart="this.classList.toggle('hover');">
                    <div class="flipper">
                        ...
                        <div class="front" >
                            <img src="images/themePage/onePage.svg" alt="" class="" id="theme1-f" onclick="check1()">
                        </div>
                        <div class="back" >
                            <img src="images/themePage/onePage-back.svg" alt="" class="" id="theme1-b" onclick="check1()">
                        </div>
                    </div>
                </div>
                ...
                <div class="flip-container theme" ontouchstart="this.classList.toggle('hover');">
                    <div class="flipper">
                        ...
                        <div class="front" >
                            <img src="images/themePage/SideMenu.svg" alt="" class="" id="theme2-f" onclick="check2()">
                        </div>
                        <div class="back" >
                            <img src="images/themePage/SideMenu-back.svg" alt="" class="" id="theme2-b" onclick="check2()">
                        </div>
                    </div>
                </div>
                ...
                <div class="flip-container theme" ontouchstart="this.classList.toggle('hover');">
                    <div class="flipper">
                        ...
                        <div class="front" >
                            <img src="images/themePage/tabular.svg" alt="" class="" id="theme3-f" onclick="check3()">
                        </div>
                        <div class="back" >
                            <img src="images/themePage/tabular-back.svg" alt="" class="" id="theme3-b" onclick="check3()">
                        </div>
                    </div>
                </div>
            </div>
            <form name="themeSelectionForm" action="createAlbum.php">
                <div id="checkboxes">
